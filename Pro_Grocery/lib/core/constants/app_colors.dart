...
class AppColors {
  ...
  static const Color primary = Color(0xD447A4C3);

  // Others Color
  static const Color scaffoldBackground = Color(0xFFFFFFFF);

  /// used for page with box background
  static const Color scaffoldWithBoxBackground = Color(0xFFE4F8EA);//0xFFE4F8EA
  static const Color cardColor = Color(0xF41FB199);
  static const Color coloredBackground = Color(0xFFFFB199);
